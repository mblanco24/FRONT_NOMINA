                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex ">
                    ...
                    <div x-data="{ open: false }" class="relative ml-4">
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            <a href="{{ route('constancias.index') }}" class="block px-4 py-2 text-gray-700 hover:bg-blue-100">Constancias de
                                trabajo</a>
                            <a href="{{ route('permisos.index') }}" class="block px-4 py-2 text-gray-700 hover:bg-blue-100">Permisos</a>
                            <a href="{{ route('transporte.index') }}" class="block px-4 py-2 text-gray-700 hover:bg-blue-100">Transporte(Entrada /Salida)</a>
                        </div>
                    </div>
                    <div x-data="{ open: false }" class="relative ml-4">
                        <button @click="open = !open"
                        ...
                        <div x-show="open" @click.away="open = false"
                            class="absolute right-0 mt-2 w-48 bg-white rounded shadow-lg z-50 py-2">
                            <a href="{{ route('honorarios.index') }}" class="block px-4 py-2 text-gray-700 hover:bg-blue-100">Pagos por honorarios</a>
                            <a href="{{ route('honorarios.index') }}" class="block px-4 py-2 text-gray-700 hover:bg-blue-100">Pagos faltante</a>
                    ...
                    <x-nav-link href="{{ route('reportesgenerales.index') }}" :active="request()->routeIs('/generales')">
